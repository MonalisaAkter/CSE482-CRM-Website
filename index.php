...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">User - <?php if (isset($_SESSION['name'])) {echo $_SESSION['name'];} ?></a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer">
                    ...
                    User - <?php if (isset($_SESSION['userid'])) {
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT Datetime, subject, SystemID, SupportType, Urgency, Status FROM ticketdetails WHERE UserID = {$_SESSION['userid']}";
