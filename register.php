                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="backend/usercreation.php">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" id="inputPasswordConfirm" type="password" placeholder="Confirm password" name="confpass" required/>
                                                    <label for="inputPasswordConfirm">Confirm Password</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button name="regbtn" id="regbtn" class="btn btn-primary btn-block" type="submit">Create Account<i id="loadicon" class="fa fa-refresh fa-spin"></i></button></div>
                                        </div>
                                    </form>
